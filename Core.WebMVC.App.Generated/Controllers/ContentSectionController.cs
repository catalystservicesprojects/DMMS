...
namespace DMMS.WebApp.Controllers
{
    ...
    {
        private readonly IContentSectionService _service;
        public ContentSectionController(IContentSectionService service)
        {
            _service = service;
        }
        ...
        //public IActionResult Create() => View(new ContentSection());
