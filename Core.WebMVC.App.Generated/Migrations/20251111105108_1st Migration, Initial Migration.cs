...
{
    /// <inheritdoc />
    public partial class _1stMigrationInitialMigration : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ContentLinksBackLinks", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ContentLinksBackLinks_Content_ContentId",
                        column: x => x.ContentId,
                        principalTable: "Content",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ContentLinksBackLinks_ContentId",
                table: "ContentLinksBackLinks",
                column: "ContentId");
